		...
		<div class="panel panel-default panel-primary">
			...
			<div class="panel-body">
				<div class="col-sm-<%=leftside%> col-sm-<%=leftside%>">
					<table>
						<tr>
							<td><img src="<%=uploadedFolder%>${bean.image}"
				...
				<div class="col-sm-<%=rightside%> col-sm-<%=rightside%>">
					<table class="table table-hover table-condensed">
						<tr>
							...
							<td width="75%" align="left">${bean.num}</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td width="75%" align="left">${bean.contents} <span class="badge">5</span>
							</td>
						</tr>
						<tr>
							<td width="25%" align="center">주문 수량</td>
							<td width="75%" align="left">
								<form class="form-inline" role="form" method="post" action="갈곳">
